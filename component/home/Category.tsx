...
// Fallback ангилалууд (backend ажиллахгүй үед)
...
// Ангилал харуулах компонент - Swiper slider ашиглана
    ...
    <section className="py-8 md:py-12 lg:py-16 bg-gray-100">
      <div className="container mx-auto px-2 sm:px-4">
        <div className="text-center pb-6 md:pb-8">
          <h3 className="text-2xl md:text-3xl font-bold mb-2">Шилдэг ангилал</h3>
          <p className="text-sm md:text-base text-gray-600 capitalize">Дуртай ангилалаа сонгоод худалдан аваарай</p>
        </div>

        {loading ? (
          <div className="text-center py-8">Ангилал ачааллаж байна...</div>
        ) : (
          <Swiper
            slidesPerView={1}
            spaceBetween={20}
